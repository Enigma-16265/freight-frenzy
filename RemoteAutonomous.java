...
//@Disabled
public class RemoteAutonomous<finalPosition> extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            sleep(2000);
                ...
                if (position < 150) {
                    ...
                    gyroDrive(0.45, 330, 170); //180
                    sleep(200);

                    catapult.setPosition(CATAPULT_IN);
                    sleep(150);

                    gyroTurn(TURN_SPEED, -72); //-71 /DECREASE MAKES IT GO AWAY FROM HUB
                    gyroHold(TURN_SPEED, -72, 0.3);

                    gyroDrive(DRIVE_SPEED, 700, -72);
                    sleep(100);

                    gyroIntakeDrive(DRIVE_SPEED, 300, -72, -300, 0.5);
                    ...
                    gyroTurn(TURN_SPEED, -150); //-30.5
                    gyroHold(TURN_SPEED, -150, 0.3);

                    gyroDrive(DRIVE_SPEED, 550, -150);
                    sleep(100);
                ...
                //MIDDLE
                    ...
                    gyroDrive(0.45, 300, 170); //180
                    sleep(200);

                    catapult.setPosition(CATAPULT_IN);
                    sleep(300);

                    gyroTurn(TURN_SPEED, -74.5);
                    gyroHold(TURN_SPEED, -74.5, 0.3);

                    gyroDrive(DRIVE_SPEED, 930, -74.5);
                    sleep(100);

                    gyroIntakeDrive(DRIVE_SPEED, 300, -74.5, -300, 0.5);
                    sleep(100);
                ...
                //TOP
                    ...
                    gyroDrive(DRIVE_SPEED, 300, 170); //180
                    sleep(200);

                    gyroTurn(TURN_SPEED, -76); //60.5
                    gyroHold(TURN_SPEED, -76, 0.3);

                    gyroDrive(DRIVE_SPEED, 1350, -76);
                    sleep(100);
