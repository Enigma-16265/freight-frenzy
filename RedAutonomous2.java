...
@Autonomous(name= "Red Autonomous Right")
//@Disabled
public class RedAutonomous2<finalPosition> extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            sleep(2000);
                ...
                if (position < 150) {
                    ...
                    gyroDrive(DRIVE_SPEED, -220, -150);
                    sleep(150);

                    catapult.setPosition(0.21);
                    sleep(800);

                    gyroDrive(DRIVE_SPEED, -70, -150);
                    sleep(150);

                    box.setPosition(0.95);
                    sleep(400);

                    gyroDrive(DRIVE_SPEED, 540, -150);
                    sleep(150);
                ...
                //MIDDLE
                    ...
                    gyroDrive(DRIVE_SPEED, -280, -150);
                    sleep(150);

                    catapult.setPosition(0.3);
                    sleep(800);

                    gyroDrive(DRIVE_SPEED, -90, -150);
                    sleep(150);
