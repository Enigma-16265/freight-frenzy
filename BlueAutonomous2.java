...
//@Disabled
public class BlueAutonomous2<finalPosition> extends LinearOpMode {
    ...
    static final double DRIVE_SPEED = 0.52;     // Nominal speed for better accuracy.
    static final double TURN_SPEED = 0.47;     // Nominal half speed for better accuracy.

    static final double HEADING_THRESHOLD = 1;      // As tight as we can make it with an integer gyro
    static final double P_TURN_COEFF = 0.027;     // Larger is more responsive, but also less stable
    static final double P_DRIVE_COEFF = 0.009;     // Larger is more responsive, but also less stable
        ...
        while (opModeIsActive()) {
            ...
            sleep(1500);
                ...
                if (position < 150) {
                    ...
                    gyroDrive(DRIVE_SPEED, 200, 0);
                    sleep(150);

                    gyroTurn(TURN_SPEED, 145);
                    gyroHold(TURN_SPEED, 145, 0.3);

                    gyroDrive(DRIVE_SPEED, -220, 145);
                    sleep(150);

                    catapult.setPosition(0.21);
                    sleep(500);

                    gyroDrive(DRIVE_SPEED, -70, 145);
                    sleep(150);

                    box.setPosition(0.95);
                    sleep(400);

                    gyroDrive(DRIVE_SPEED, 440, 145);
                    sleep(150);
                    ...
                    gyroDrive(DRIVE_SPEED, 1000, 90);
                    sleep(150);

                    intakeIntake(-500, 0.5);
                    sleep(200);

                    box.setPosition(BOX_IN);

                    intakeIntake(300, 0.5);

                    gyroDrive(DRIVE_SPEED, -1200, 90); //???
                    sleep(150);

                    Drive(250, -250, -250, 250, 0.5);
                    sleep(100);

                    gyroTurn(TURN_SPEED, 155); //MAYEB CHANGE TO TURN INTO HUB MORE
                    gyroHold(TURN_SPEED, 155, 0.3);

                    gyroDrive(DRIVE_SPEED, -490, 155);
                    sleep(150);
                ...
                //MIDDLE
                    ...
                    gyroDrive(DRIVE_SPEED, -280, 145);
                    sleep(150);

                    catapult.setPosition(0.3);
                    sleep(500);

                    gyroDrive(DRIVE_SPEED, -120, 145);
                    sleep(150);

                    box.setPosition(0.95);
                    sleep(400);

                    gyroDrive(DRIVE_SPEED, 460, 145);
                    sleep(150);
                ...
                //TOP
                    ...
                    gyroDrive(DRIVE_SPEED, -490, 155); //470
                    sleep(150);
