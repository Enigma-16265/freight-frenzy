...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 4.01575; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 1.88976; // in; offset of the lateral wheel
